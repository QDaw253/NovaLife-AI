    ...
    <div className="goals-page">
      ...
      <header className="goals-header">
        <div>
          ...
          <p className="goals-header-description">
            Theo dõi tiến độ và từng bước hoàn thành
            những điều bạn đang hướng tới.
          </p>
        </div>

        <button
          className="goals-create-button"
          type="button"
      ...
      {goals.length === 0 ? (
        <section className="goals-empty">
          ...
          <p>
            Tạo một mục tiêu để NovaLife giúp bạn
            xây dựng lộ trình và theo dõi tiến độ.
          </p>
