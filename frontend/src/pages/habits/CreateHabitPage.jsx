  ...
  return (
    <div className="habit-create-page">
      <div className="habit-create-header">
        <button type="button" className="habit-back-button" onClick={() => navigate('/habits')}>
          ← Quay lại thói quen
        </button>
        <div className="habit-create-eyebrow">THÓI QUEN MỚI</div>
        <h1>Tạo thói quen</h1>
        <p>Xây dựng những thay đổi nhỏ và duy trì chúng mỗi ngày. NovaLife sẽ giúp bạn theo dõi hành trình của mình.</p>
      </div>

      <div className="habit-create-layout">
        <form className="habit-create-form" onSubmit={handleSubmit}>
          <section className="habit-form-section">
            <div className="habit-section-info">
              ...
              <div>
                ...
                <p>Mô tả điều bạn muốn duy trì thường xuyên.</p>
              </div>
            </div>

            <div className="habit-section-fields">
              <div className={`habit-field ${fieldErrors.title ? 'has-error' : ''}`}>
                ...
                <input
                  ...
                  required
                />
                <small>Hãy nhập một hành động cụ thể mà bạn muốn duy trì.</small>
                {renderFieldErrors('title')}
              </div>

              <div className={`habit-field ${fieldErrors.description ? 'has-error' : ''}`}>
          ...
          <section className="habit-form-section">
            <div className="habit-section-info">
              ...
              <div>
                ...
                <p>Chọn danh mục, tần suất và mục tiêu phù hợp.</p>
              </div>
            </div>

            <div className="habit-section-fields">
              <div className="habit-field-row">
                <div className={`habit-field ${fieldErrors.category ? 'has-error' : ''}`}>
                ...
                <div className={`habit-field ${fieldErrors.frequency ? 'has-error' : ''}`}>
              ...
              <div className="habit-field-row">
                <div className={`habit-field ${fieldErrors.target_value ? 'has-error' : ''}`}>
                ...
                <div className={`habit-field ${fieldErrors.unit ? 'has-error' : ''}`}>
          ...
          <section className="habit-form-section">
            <div className="habit-section-info">
              ...
              <div>
                <h2>Thời gian</h2>
                <p>Xác định thời gian thực hiện và lời nhắc.</p>
              </div>
            </div>

            <div className="habit-section-fields">
              <div className="habit-field-row">
                <div className={`habit-field ${fieldErrors.start_date ? 'has-error' : ''}`}>
                  <label htmlFor="start_date">Ngày bắt đầu<span>*</span></label>
                ...
                <div className={`habit-field ${fieldErrors.end_date ? 'has-error' : ''}`}>
                  ...
                  />
                  <small>Có thể để trống nếu bạn muốn duy trì lâu dài.</small>
                  {renderFieldErrors('end_date')}
                </div>
              </div>

              <div className={`habit-field ${fieldErrors.reminder_time ? 'has-error' : ''}`}>
                ...
                <small>NovaLife sẽ sử dụng thời gian này để nhắc bạn duy trì thói quen.</small>
          ...
          <div className="habit-form-actions">
            <button type="button" className="habit-cancel-button" onClick={() => navigate('/habits')} disabled={submitting}>
              Hủy
            </button>
            <button type="submit" className="habit-submit-button" disabled={submitting}>
        ...
        <aside className="habit-create-guide">
          <div className="habit-guide-icon">✓</div>
          <h2>Một thói quen tốt nên...</h2>
          <div className="habit-guide-item">
            <span>01</span>
            <div>
              <strong>Dễ bắt đầu</strong>
              <p>Bắt đầu từ một hành động nhỏ mà bạn có thể duy trì.</p>
            </div>
          </div>
          <div className="habit-guide-item">
            <span>02</span>
            <div>
              ...
              <p>Sử dụng số lần, phút, lít hoặc một đơn vị cụ thể.</p>
            </div>
          </div>
          <div className="habit-guide-item">
            <span>03</span>
            <div>
              ...
              <p>Chọn tần suất phù hợp với lịch sinh hoạt của bạn.</p>
            </div>
          </div>
          <div className="habit-guide-item">
            <span>04</span>
            <div>
              ...
              <p>Một thời điểm cố định giúp bạn dễ hình thành thói quen hơn.</p>
            </div>
          </div>
        </aside>
      </div>
