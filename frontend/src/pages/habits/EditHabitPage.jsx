  ...
  return (
    <div className="habit-edit-page">
      ...
      <div className="habit-edit-header">
        ...
        <p>
          Điều chỉnh thói quen để phù hợp
          hơn với mục tiêu và nhịp sống
          hiện tại của bạn.
        </p>
      ...
      <div className="habit-edit-layout">
          ...
          <section className="habit-edit-section">
            ...
            <div className="habit-edit-section-info">
              ...
              <div>
                ...
                <p>
                  Điều chỉnh tần suất và
                  mức độ để phù hợp với
                  khả năng hiện tại.
                </p>
              </div>
            ...
            <div className="habit-edit-fields">
              ...
              >
                ...
                <small>
                  Ví dụ: từ hằng ngày chuyển
                  sang hằng tuần nếu lịch
                  trình thay đổi.
                </small>
              ...
              <div className="habit-edit-target-note">
                ...
                <p>
                  ...
                  mục tiêu khi khả năng và
                  lịch trình thay đổi. Các bản
                  ghi tiến độ đã có vẫn được
                  giữ nguyên.
                </p>
        ...
        <aside className="habit-edit-guide">
          ...
          <p className="habit-edit-guide-description">
            Khi khả năng hoặc lịch trình
            thay đổi, hãy điều chỉnh mục tiêu
            để thói quen vẫn thực tế và có thể
            duy trì.
          </p>
          ...
          <div className="habit-edit-tip">
            ...
            <div>
              ...
              <p>
                Khi đã quen với thói quen
                hiện tại, bạn có thể nâng
                mục tiêu lên.
              </p>
            </div>
          ...
          <div className="habit-edit-tip">
            ...
            <div>
              ...
              <p>
                Một mục tiêu nhỏ nhưng duy trì
                được vẫn tốt hơn việc bỏ cuộc
                hoàn toàn.
              </p>
            </div>
          ...
          <div className="habit-edit-tip">
            ...
            <div>
              ...
              <p>
                Daily, weekly hoặc monthly
                có thể thay đổi theo lịch
                trình của bạn.
              </p>
            </div>
