  ...
  useEffect(() => {
    const fetchHabit = async () => {
      try {
        ...
        setError(
          'Không thể tải thông tin thói quen.'
        )
      } finally {
        setLoading(false)
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (responseData?.message) {
        ...
        setError(
          'Không thể cập nhật thói quen. Vui lòng kiểm tra lại thông tin.'
        )
      }
    } finally {
      setSubmitting(false)
  ...
  if (loading) {
    return (
      <div className="habit-edit-state">
        ...
        <p>
          NovaLife đang chuẩn bị thông tin của bạn.
        </p>
  ...
  return (
    <div className="habit-edit-page">
      ...
      <div className="habit-edit-header">
        ...
        <div className="habit-edit-eyebrow">
          CHỈNH SỬA
        </div>
        ...
        <p>
          Điều chỉnh thói quen để phù hợp hơn
          với mục tiêu và nhịp sống hiện tại
          của bạn.
        </p>
      ...
      <div className="habit-edit-layout">
        ...
        >
          ...
          <section className="habit-edit-section">
            ...
            <div className="habit-edit-section-info">
              ...
              <div className="habit-edit-section-number">
                01
              </div>
              ...
              <div>
                ...
                <p>
                  Cập nhật tên, mô tả và danh mục
                  của thói quen.
                </p>
              </div>
            ...
            <div className="habit-edit-fields">
              ...
              <div className="habit-edit-field">
          ...
          <section className="habit-edit-section">
            ...
            <div className="habit-edit-section-info">
              ...
              <div>
                ...
                <p>
                  Điều chỉnh tần suất và mức độ
                  để phù hợp với khả năng hiện tại.
                </p>
              </div>
            ...
            <div className="habit-edit-fields">
              ...
              <div className="habit-edit-field">
                ...
                <small>
                  Ví dụ: từ hằng ngày chuyển sang
                  hằng tuần nếu lịch trình thay đổi.
                </small>
              ...
              <div className="habit-edit-target-note">
                ...
                <p>
                  Bạn có thể tăng hoặc giảm mục tiêu
                  khi khả năng và lịch trình thay đổi.
                  Các bản ghi tiến độ đã có vẫn được
                  giữ nguyên.
                </p>
          ...
          {error && (
            <div className="habit-edit-error">
              {error}
            </div>
          )}
        ...
        <aside className="habit-edit-guide">
          ...
          <div className="habit-edit-guide-icon">
            ✓
          </div>

          <p className="habit-edit-guide-label">
            NOVALIFE HABITS
          </p>

          <h2>
            Thói quen có thể thay đổi cùng bạn.
          </h2>

          <p className="habit-edit-guide-description">
            Khi khả năng hoặc lịch trình thay đổi,
            hãy điều chỉnh mục tiêu để thói quen
            vẫn thực tế và có thể duy trì.
          </p>
          ...
          <div className="habit-edit-tip">
            ...
            <div>
              ...
              <p>
                Khi đã quen với thói quen hiện tại,
                bạn có thể nâng mục tiêu lên.
              </p>
            </div>
          ...
          <div className="habit-edit-tip">
            ...
            <div>
              ...
              <p>
                Một mục tiêu nhỏ nhưng duy trì được
                vẫn tốt hơn việc bỏ cuộc hoàn toàn.
              </p>
            </div>
          ...
          <div className="habit-edit-tip">
            ...
            <div>
              ...
              <p>
                Daily, weekly hoặc monthly có thể
                thay đổi theo lịch trình của bạn.
              </p>
            </div>
