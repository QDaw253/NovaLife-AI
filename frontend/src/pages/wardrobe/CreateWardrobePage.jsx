    ...
    <div className="wardrobe-create-page">
      ...
      <div className="wardrobe-create-layout">
        <form className="wardrobe-create-form" onSubmit={handleSubmit}>
          <section className="wardrobe-create-section">
            ...
            <div className="wardrobe-create-section-fields">
              <div className={`wardrobe-create-image-box ${fieldErrors.image ? 'has-error' : ''}`}>
                {preview ? (
                  <>
                    ...
                    <button type="button" className="wardrobe-create-remove-image" onClick={handleRemoveImage}>×</button>
                  </>
                ) : (
              ...
              {image && (
                <button type="button" className="wardrobe-create-analyze" onClick={handleAnalyzeImage} disabled={analyzing}>
          ...
          <div className="wardrobe-create-actions">
            <button type="button" className="wardrobe-create-cancel" onClick={() => navigate('/wardrobe')} disabled={submitting}>
              Hủy
            </button>
        ...
        <aside className="wardrobe-create-guide">
          ...
          <p>Tải lên một ảnh rõ ràng và NovaLife sẽ gợi ý tên, loại, màu sắc, mùa và hoàn cảnh sử dụng.</p>
