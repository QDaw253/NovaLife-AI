...
function WardrobeDetailPage() {
  ...
  const handleDelete = async () => {
    const confirmed = window.confirm(
      'Bạn có chắc muốn xóa trang phục này khỏi tủ đồ không?'
    )
    ...
    try {
      ...
      alert(
        'Không thể xóa trang phục. Vui lòng thử lại.'
      )
    } finally {
      setDeleting(false)
    }
  ...
  if (error || !item) {
    return (
      <div className="wardrobe-detail-page">
        <div className="wardrobe-detail-state">
          <p>
            {error || 'Không tìm thấy trang phục.'}
          </p>

          <Link
            to="/wardrobe"
            className="wardrobe-detail-back"
          >
            ← Quay lại tủ đồ
          </Link>
        </div>
  ...
  return (
    <div className="wardrobe-detail-page">
      ...
      <div className="wardrobe-detail-header">
        ...
        <div>
          <p className="wardrobe-detail-eyebrow">
            CHI TIẾT TRANG PHỤC
          </p>
          ...
          <p className="wardrobe-detail-subtitle">
            Xem và quản lý thông tin món đồ
            trong tủ đồ của bạn.
          </p>
        </div>
        ...
        {item.is_favorite && (
          <div className="wardrobe-detail-favorite-badge">
            ♥ Yêu thích
          </div>
        )}
      ...
      <div className="wardrobe-detail-card">
        ...
        <div className="wardrobe-detail-image-section">
          ...
          <div className="wardrobe-detail-section-number">
            01
          </div>
        ...
        <div className="wardrobe-detail-info-section">
          ...
          <div className="wardrobe-detail-actions">
            ...
            <Link
              ...
              className="wardrobe-detail-edit-button"
            >
              <span>✎</span>
              Chỉnh sửa
            </Link>
